...
# JzFrameWork
This is a high-performance Android development framework that achieves almost zero-delay screen transitions. It adopts an active multiple fragment architecture to support all versions of android projects. The framework uses kotlin and androidx for development to help developers in Deploy your application in the shortest time. This framework will continue to be updated, but it can only meet its own development needs. If there are other customized requirements, please clone it and modify it!<br><br>
